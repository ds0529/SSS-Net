...
class ScanNet:
    ...
    def load_sub_sampled_clouds(self, sub_grid_size):
        ...
        for i, file_path in enumerate(self.all_files):
            ...
            kd_tree_file = join(tree_path, split_name, '{:s}_KDTree.pkl'.format(cloud_idx))  # 树
            sub_ply_file = join(tree_path, split_name, '{:s}.ply'.format(cloud_idx))  # 子点云
            ...
            rg_file = join(self.rg_path, '{:s}.txt'.format(cloud_idx))  # 子点云
            rgRGB_file = join(self.rgRGB_path, '{:s}.txt'.format(cloud_idx))  # 子点云
            rg_combine_file = join(self.rg_combine_path, '{:s}.txt'.format(cloud_idx))  # 子点云
