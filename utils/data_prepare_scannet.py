...
dataset_path = '/home/newdisk/dengshuang/scannet/pickle_xyzrgb'
# dataset_path = '/share/group/datanlpr9/data/scannet/pickle_xyzrgb'
...
def convert_pc2ply(cloud_data, cloud_label, idx, save_path):
    ...
    write_ply(final_save_path, (xyz, colors, labels), ['x', 'y', 'z', 'red', 'green', 'blue', 'class'])

    # save sub_cloud and KDTree file
    sub_xyz, sub_colors, sub_labels = DP.grid_sub_sampling(xyz, colors, labels=labels, grid_size=sub_grid_size)
...
if __name__ == '__main__':
    train_load_file = open(join(dataset_path, "scannet_train_rgb21c_pointid.pickle"), "rb")
    test_load_file = open(join(dataset_path, "scannet_val_rgb21c_pointid.pickle"), "rb")
